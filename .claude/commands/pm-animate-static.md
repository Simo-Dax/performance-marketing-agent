...
6. 🚦 Gate: durata (default 4s) + risoluzione (1080p default) + **costo confermato** prima di renderizzare.
7. Percorsi: A manuale (gratis) · B Higgsfield · C fal.ai (`/pm-setup-fal-ai`). Serve un modello image-to-video con **start image (primo frame) conditioning**.
