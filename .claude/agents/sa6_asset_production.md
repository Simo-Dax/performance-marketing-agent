...
- **`25_ugc_prompt`** (UGC Factory) → comando `/pm-ugc-video` — **alternativa** a `57` per il fan-out Andromeda (4 varianti da uno script unico). Le due non si toccano: 57 scrive solo sotto `studio/`.
