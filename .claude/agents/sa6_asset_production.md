...
- Serve un **video UGC** → tre lane: `57_ugc_studio` (default, da format bank di winner) · `58_ugc_blueprint` (l'utente ha GIÀ un video che gli piace e vuole quella struttura) · `25_ugc_prompt` (fan-out Andromeda da uno script)
